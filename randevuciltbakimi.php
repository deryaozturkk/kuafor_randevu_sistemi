...
<div class="container mt-3">
  ...
  <h2>Cilt Bakımı Hizmetleri</h2>
    <label for="skincare" class="form-label">Yaptırmak istediğiniz işlemi seçiniz:</label>
    <input class="form-control" list="skincares" name="skincare" id="skincare">
    <datalist id="skincares">
  ...
  <h2>Personel Seçimi</h2>
    ...
    <datalist id="personels">
      <option value="İrem Salaman">
      <option value="Ayşe Ömür">
